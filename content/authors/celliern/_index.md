...
# Role/position
role: Post-doctorant / Ingénieur de recherche, support numérique à la recherche
...
bio: Ici pour résoudre des problèmes scientifiques avec mon ordinateur. Ma spécialité principale est la résolution d'équations aux dérivées partielles type modèles d'écoulement surface libre, mais j'ai de nombreuses autres cordes à mon arc.
...
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/ncpwass
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?user=lYq2_wEAAAAJ
- icon: github
  icon_pack: fab
  link: https://github.com/celliern
